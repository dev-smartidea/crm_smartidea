...
แก้ไข md / เพิ่มลูกค้าหน้า ledgar / เพิ่ม invGg / แก้ acc ledgar ให้ fix column / แก้ไข acc หน้า approve ให้ ปุ่มแก้ไขได้ / เพิ่มช่องค้นหาตาม cid หน้า approve acc / ทำให้สามารถใส่ . แทน  : / / ทำให้สามารถใส่ . แทน  : หน้า AccountFacebookPage.js และ AccountGooglePage.js / แก้ไขยอดเงินในบัตรคงเหลือรวม / เพิ่ม สัปดาห์ นี้ สัปดาห์ที่แล้ว แล้วก็เดือนนี้ กับเดือนที่แล้ว หน้า CardDailySummary / เพิ่มปุ่ม export customer / คำนวนยอดสถานะธุรกรรมใหม่ / เพิ่มตัวกรองหน้า ledgar / แก้ไขฟอร์ม กำหนดวันรันโฆษณา / แก้ cardhistory /ให้แทปเลือนไปข้างๆ ขึ้นมาอยู่ตรงข้างบนคอลลัมน์ / ให้ admin แก้ไขบริการได้ทั้งหมด / แก้ไขยอดเติมเงินได้ และจะคำนวนตามยอดเงินคงเหลือในบัญชี หน้า FB GG / แก้ไข bug การ อนุมัติ slip image / เพิ่มฟังก์ชันค้นหาตาม transaction id หน้า approve transaction ของ role acc / ทำ cleanup_old_slips หลังจากผ่านไป 90 วัน / แก้ส่วน export csv / revert ไปก่อนที่จะทำ easy slip / เพิ่มฟังก์ชัน slip verify
