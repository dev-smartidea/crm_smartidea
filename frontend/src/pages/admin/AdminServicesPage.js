              ...
              <form className="svc-form" onSubmit={(e) => { e.preventDefault(); saveDetailEdit(); }}>
                <label>
                  ...
                  <input 
                    ...
                    disabled={!['admin', 'google_manager', 'facebook_manager'].includes(userRole)} 
                    style={!['admin', 'google_manager', 'facebook_manager'].includes(userRole) ? { background: '#f5f5f5', cursor: 'not-allowed' } : {}} 
                  />
                </label>
                <label>
                  Website / Facebook Page
